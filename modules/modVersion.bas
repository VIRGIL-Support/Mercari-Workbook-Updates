...
Private Function CheckForPendingTransfer() As Boolean
    ...
    ' Show friendly message before auto-transfer
    MsgBox "I'm almost finished getting everything set up for you!" & vbCrLf & vbCrLf & _
           "When you press OK, don't worry if it takes me up to a minute to respond. " & _
           "I'll be busy transferring all of your item data from the old workbook " & _
           "into this shiny updated version, and then double-checking to make sure " & _
           "everything is perfect for you.", vbInformation, "Almost There!"
    
    ' Auto-run the transfer (no button needed)
    TransferMyData
End Function
